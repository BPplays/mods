...
function Helpers.toRange(a, range_start, range_end)
    if range_end == range_start then return 0 end
    local t = (a - range_start) / (range_end - range_start)
    return math.max(0, math.min(1, t))
end

function Helpers.Interp(a, b, t)
